        ...
        <>
            ...
            <div className='w-full flex justify-center bg-slate-200'>
                <div className='sm:w-full md:container my-20 sm:px-10 md:px-20 z-cl-secondary'>
                    <div>
                        <h1 className='text-2xl font-medium'>WHAT I DO</h1>
                        <h1 className='text-6xl font-bold z-cl-primary'>SKILLS, TECH STACKS & TOOLS</h1>
                    ...
                    <div className='grid sm:grid-cols-1 md:grid-cols-4 my-20 sm:px-10 md:px-20 z-cl-secondary'>
                        ...
                        <div className='m-2 p-4 text-center bg-slate-100 shadow-2xl hover:shadow-md'>Familiarity with <span className='z-cl-spn'>NoSQL</span> databases such as <span className='z-cl-spn'>MongoDB</span>, <span className='z-cl-spn'>Firebase</span>, and <span className='z-cl-spn'>Firestore</span> for storing and retrieving data.</div>
                        <div className='m-2 p-4 text-center bg-slate-100 shadow-2xl hover:shadow-md'>Expertise in implementing <span className='z-cl-spn'>CRUD</span> (Create, Read, Update, Delete) operations using the <span className='z-cl-spn'>MERN</span> (MongoDB, Express.js, React.js, Node.js) and <span className='z-cl-spn'>MEVN</span> (MongoDB, Express.js, Vue.js, Node.js) stacks.</div>
                        <div className='m-2 p-4 text-center bg-slate-100 shadow-2xl hover:shadow-md'>Proficient in utilizing <span className='z-cl-spn'>Firebase</span> and <span className='z-cl-spn'>Firestore</span> for real-time data synchronization and building secure and scalable applications.</div>
                        <div className='m-2 p-4 text-center bg-slate-100 shadow-2xl hover:shadow-md'>Strong problem-solving skills and the ability to <span className='z-cl-spn'>debug</span> and <span className='z-cl-spn'>troubleshoot</span> code effectively.</div>
